...
{
    public class WaraSingleLineTextField : Control, IWaraControl
    {
        ...
        public WaraSingleLineTextField()
        {
        ...
        private class BaseTextBox : TextBox
        {
            ...
            public BaseTextBox()
            {
                WaraContextMenuStrip cms = new TextBoxContextMenuStrip();
        ...
        private class TextBoxContextMenuStrip : WaraContextMenuStrip
        {
            public readonly ToolStripItem undo = new WaraToolStripMenuItem { Text = "Undo" };
            public readonly ToolStripItem seperator1 = new ToolStripSeparator();
            public readonly ToolStripItem cut = new WaraToolStripMenuItem { Text = "Cut" };
            public readonly ToolStripItem copy = new WaraToolStripMenuItem { Text = "Copy" };
            public readonly ToolStripItem paste = new WaraToolStripMenuItem { Text = "Paste" };
            public readonly ToolStripItem delete = new WaraToolStripMenuItem { Text = "Delete" };
            public readonly ToolStripItem seperator2 = new ToolStripSeparator();
            public readonly ToolStripItem selectAll = new WaraToolStripMenuItem { Text = "Select All" };
