...
{
    public class WaraContextMenuStrip : ContextMenuStrip, IWaraControl
    {
        ...
        public WaraContextMenuStrip()
        {
            Renderer = new WaraToolStripRender();
    ...
    public class WaraToolStripMenuItem : ToolStripMenuItem
    {
        public WaraToolStripMenuItem()
        {
            AutoSize = false;
        ...
        protected override ToolStripDropDown CreateDefaultDropDown()
        {
            ...
            var defaultDropDown = new WaraContextMenuStrip();
    ...
    internal class WaraToolStripRender : ToolStripProfessionalRenderer, IWaraControl
    {
        //Properties for managing the material design properties
        public int Depth { get; set; }
        public WaraSkinManager SkinManager { get { return WaraSkinManager.Instance; } }
